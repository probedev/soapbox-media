      ...
      <section className="px-6 pt-10 pb-16 max-w-3xl mx-auto">
        ...
        <article
          className="
            ...
            prose-h3:mt-8 prose-h3:mb-3 prose-h3:text-base prose-h3:uppercase prose-h3:tracking-wider prose-h3:text-muted-foreground
            prose-p:text-ink-body prose-p:leading-relaxed
            prose-li:text-ink-body prose-li:my-1
            prose-strong:text-foreground
            prose-code:bg-muted prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-ink-strong prose-code:font-normal prose-code:text-sm
            prose-code:before:content-none prose-code:after:content-none
            prose-a:text-foreground prose-a:underline hover:prose-a:text-ink-body
          "
        >
