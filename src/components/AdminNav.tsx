/**
 * Small shared nav across the (Basic-Auth-gated) /admin/* pages so the
 * internal tools are discoverable from one another.
 */
const LINKS = [
...
export function AdminNav({ active }: { active?: string }) {
  return (
    <div className="flex items-center gap-1 border-b border-gray-200 mb-6 text-sm">
      ...
      <a
        href="/"
        className="ml-auto px-3 py-2 text-gray-400 hover:text-gray-700 text-xs"
      >
        View site →
      </a>
    </div>
