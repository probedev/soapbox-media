...
export const SEED_CHANNELS: SeedChannel[] = [
  ...
  // ─── M — Middle / cross-cutting (7) ────────────────────────────────
  { name: "The Joe Rogan Experience", lean: "M", podcastSearchName: "Joe Rogan Experience", reachEstimate: 14_500_000, rationale: "Largest single voice in alt-media; non-partisan posture, R-curious content" },
  ...
  // ─── R — Right (18) ────────────────────────────────────────────────
  { name: "The Ben Shapiro Show", lean: "R", youtubeHandle: "@benshapiro", podcastSearchName: "The Ben Shapiro Show", reachEstimate: 7_000_000, rationale: "Most-influential R podcast; intellectual conservatism" },
